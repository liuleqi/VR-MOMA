...
window.addEventListener('load', function () {
    ...
    (function () {
        ...
        var sceneURL = params.load ? params.load : '__URL__Art_Gallery.gltf'.replace('__URL__', '');
        if (!sceneURL) {
    ...
    function prepareExternalInterface(app) {
        ...
        // }
        app.ExternalInterface.loaded = function() {
            console.log('Hello, World!');  
        }

        app.ExternalInterface.clickObject = function(objName) {
            if (mousemoving == 0) {
                v3d.puzzles.procedures.Click_Object(objName);
                console.log(objName);
            }
        }

        app.ExternalInterface.descModal = function(descContent) {
            if (mousemoving == 0) {
                parent.vm.description(descContent); 
                console.log("Show DescModal") 
            }
        }

        app.ExternalInterface.vrAlert = function(vr_available) {
            parent.vm.vr_available(vr_available); 
        }
    ...
    function runCode(app) {
        ...
        function mouseDown() {
            mousemoving = 0;
            console.log("mousedown:mousemoving = "+mousemoving);
        }
        function mouseMove() {
            mousemoving = 1;
            console.log("mousemove:mousemoving = "+mousemoving);
        }
        function onTouch() {
            mousemoving = 0;
        }
...
function orbit() {
    v3d.puzzles.procedures.ModelOrbit()
}
function fp() {
    v3d.puzzles.procedures.ModelFirstPerson()
}
function vr() {
    v3d.puzzles.procedures.ModelVr()
}

function forward(params) {
    v3d.puzzles.procedures.MoveForward(params)
}
function back(params) {
    v3d.puzzles.procedures.MoveBack(params)
}
function left(params) {
    v3d.puzzles.procedures.MoveLeft(params)
}
function right(params) {
    v3d.puzzles.procedures.MoveRight(params)
}
